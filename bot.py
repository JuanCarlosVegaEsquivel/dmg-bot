...
def damage_rating(crit):
    if crit >= 10_000_000: return "🔴 God Roll"
    if crit >= 5_000_000:   return "🟠 Endgame"
    if crit >= 1_00_000:   return "🟡 Late Game"
    if crit >= 500_000:    return "🟢 Mid Game"
    if crit >= 50_000:     return "🔵 Early Mid"
    return "⚪ Early Game"
